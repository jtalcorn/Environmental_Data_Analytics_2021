...
library(tidyverse)
library(lubridate)
Neonics <- read.csv("Z:/ENV_872_Data_Analy/Environmental_Data_Analytics_2021/Data/Raw/ECOTOX_Neonicotinoids_Insects_raw.csv", header = TRUE)
Litter <- read.csv('Z:/ENV_872_Data_Analy/Environmental_Data_Analytics_2021/Data/Raw/NEON_NIWO_Litter_massdata_2018-08_raw.csv')
```
...
> Answer: 12 different plots were sampled at NIWOT Ridge. The unique function tells you how many unique values are in a column. It eliminates duplicate values. The summary function tells us how many samples total were taken. 
